...
get_balance: function(addAmount = 1000) {
    // Read current credits
    let currentCredits = parseInt($('#credits').html(), 10) || 0;

    // Compute new credits by adding optional amount
    let newCredits = currentCredits + addAmount;

    // Update the DOM
    $('#credits').html(newCredits);

    // Return the new balance if needed
    return newCredits;
},
